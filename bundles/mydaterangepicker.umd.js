            ...
            if (i === 1) {
                ...
                for (var j = pm; j <= dInPrevM; j++) {
                    ...
                    week.push({ dateObj: date,
                        setBackground: this.getDate(dateSetBackground) < new Date(),
